...
<body>
    <?php
        if(isset($_POST['submit'])){
            ...
            function CreateArray($input){ //Tạo mảng số ngẫu nhiên
                $array = array();
                for($i = 0; $i<$input; $i++){
                    $array[] = rand(0, 20);
                }
            ...
            $array = implode(" ", $createArray); // Chuyển từ mảng về chuỗi
    ...
    <form action="" method="post" name="exercise_3">
        <table align="center" style="border: 1px solid;">
            ...
            <tr style="background-color: pink;">
                <td></td>
                <td >
                    <input size="16" style="background-color: yellow;" type="submit" name="submit" value="Phát sinh và tính toán">
                </td>
            </tr>
            <tr>
                <td>Mảng:</td>
            ...
            <tr>
                <td style="text-align: center;" colspan="2">(<strong style="color: red;">Ghi chú:</strong> Các phần tử trong mảng sẽ có giá trị từ 0 đến 20)</td>
            </tr>
        </table>
    </form>
</body>
