...
<body>
    <?php
        if(isset($_POST['replace'])){
            ...
            function PrintArray($array){ //Hàm in mảng
                $string = implode("  ", $array);
                return $string;
            }

            function Replace($indexReplace, $indexReplaced, $array){ //Hàm thay thế
            ...
            else $msg = "*Mảng không hợp lệ";
        }
    ?>
    <form action="" method="post" name="replace">
        <table align="center" style="background-color: #FFF0F5;">
            <tr>
            ...
            <tr style="background-color: #FFC0CB;">
                ...
                <td>
                    <input required type="number" name="indexReplaced" value="<?php
                        if(isset($indexReplaced))   echo $indexReplaced;
                    ?>">
                </td>
            </tr>
            <tr style="background-color: #FFC0CB;">
                ...
                <td>
                    <input required type="number" name="indexReplace" value="<?php
                        if(isset($indexReplace))   echo $indexReplace;
                    ?>">
                </td>
            </tr>
            <tr style="background-color: #FFC0CB;">
            ...
            <tr>
                ...
                <td>
                    <input readonly style="background-color: #FF7F50;" type="text" name="oldArray" size="40" value="<?php
                        if(isset($oldArray))   echo $oldArray;
                    ?>">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input readonly style="background-color: #FF7F50;" type="text" name="newArray" size="40" value="<?php
                        if(isset($newArray))   echo $newArray;
                    ?>">
                </td>
            </tr>
            <tr>
